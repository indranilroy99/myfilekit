export const tools = [
  ...
  tool("invoice-generator-tool", "Invoice Generator", "Business Tools", "Open the premium invoice editor with templates, taxes, payments, signatures, and brand controls.", ["invoice", "tax invoice", "bill", "receipt", "quote", "estimate", "business document"], ["Business"]),
