...
[![Version](https://img.shields.io/badge/version-3.9.0-2563eb)](./package.json)
...
The current version is `3.9.0`. See [CHANGELOG.md](./CHANGELOG.md) and use the repository scripts to create intentional releases:
