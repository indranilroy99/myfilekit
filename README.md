...
[![Version](https://img.shields.io/badge/version-3.21.4-2563eb)](./package.json)
...
The current version is `3.21.4`. See [CHANGELOG.md](./CHANGELOG.md) and use the repository scripts to create intentional releases:
